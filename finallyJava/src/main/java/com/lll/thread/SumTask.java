...
/**
 * Created by Fayne on 2018/09/17.
 */
...
//        test2(array);
    ...
    private static void test2(long[] array) throws InterruptedException, ExecutionException {
        ...
        System.out.println(String.format("结果2 %s 耗时 %sms", result, end - begin));
    }

    private static void test1(long[] array) throws InterruptedException, ExecutionException {
        System.out.println(Arrays.toString(array));
        ...
        System.out.println(String.format("结果1 %s 耗时 %sms", result, end - begin));
    }
