package com.lll.algorithm.tree.bst.byO;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if(FileOperations.readFile(filename, words)){
            ...
            // 输出圣经中god一词出现的频率
            if( bst.contain(searchname) )
                System.out.println(searchname+": " + bst.search(searchname) );
            else
                System.out.println("No word "+searchname+" in " + filename);
            ...
            // 输出圣经中god一词出现的频率
            if( sst.contain(searchname) )
                System.out.println(searchname+" : " + sst.search(searchname) );
            else
                System.out.println("No word "+searchname+" in " + filename);
