...
//        System.out.println(strings);
        ...
        System.out.println(":" +Student.class.getResource("demo.json"));
    }
    ...
    public void customSettings() throws JsonProcessingException{
        ...
        DeserializationFeature f3=  DeserializationFeature.ACCEPT_FLOAT_AS_INT;
        boolean b1 = true;
        objectMapper.configure(f3, true);
